 ...
 */
export const createKhora = Effect.fn("View.chat.createKhora")(function* (
  nodeId: Id.Node,
  frameId: Id.Frame,
  ...
  yield* Effect.logDebug("[View.chat.createKhora] Message created").pipe(
    Effect.annotateLogs({
      chatNodeId,
      newNodeId,
      isTitle,
